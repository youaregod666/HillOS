...
local function newSwitchAndLabel(width, color, text, state)
	return GUI.switchAndLabel(1, 1, width, 6, color, 0x333333, 0xF0F0F0, 0x000000, text .. ":", state)
end
...
local function addStageButton(text)
	local button = stageButtonsLayout:addChild(GUI.adaptiveRoundedButton(1, 1, 2, 0, 0x333333, 0xCCCCCC, 0xCCCCCC, 0x333333, text))
...
local acceptSwitchAndLabel = newSwitchAndLabel(18, 0x33CC33, "", false)

local acceptSwitchAndLabel2 = newSwitchAndLabel(18, 0x33CC33, "", false)
